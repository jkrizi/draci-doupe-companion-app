...
ALTER TABLE TREASURE_BLUEPRINT ADD CONSTRAINT TREASURE_BLUEPRINT_GEMSTONE_ID_FK FOREIGN KEY (GEM_STONE_ID) REFERENCES GEMSTONE (ID);
...
--changeset Jan.Zatloukal:1576766708146-74
